...
```sh
  git clone https://github.com/kazim110/Awesome-Books-ES6.git
```
...
This project is [MIT](https://github.com/kazim110/Awesome-Books-ES6/blob/add-remove-books/LICENSE) licensed.
